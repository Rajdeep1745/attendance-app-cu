...
export default function LandingPage() {
  ...
  const logo = "images/logos/logoTransparent.png";
  ...
  return (
    <div className="landing-page">
        ...
        <div className="hero-content">
          <h1 className="hero-title">
            <div className="title-line-1">
              ...
              <span className="attendance-rest">ttendify</span>
            </div>
          ...
          <p className="hero-subtitle">
            Intelligent attendance tracking, AI-assisted teaching workflows,
            real-time analytics, and face-recognition powered classroom
            automation.
          </p>
      ...
      <section className="developers-section">
        ...
        <div className="developer-grid">
          <div className="developer-card">
            <div className="developer-avatar">JS</div>

            <h3>Jinea Saha</h3>

            <p>
              Frontend Architecture, UI/UX, Attendance Workflows and System
              Design
            </p>
          </div>

          <div className="developer-card">
            <div className="developer-avatar">RS</div>

            <h3>Rajdeep Sarkar</h3>

            <p>
              Backend APIs, Database Architecture, Authentication & Face
              Recognition
            </p>
          </div>
        </div>
      ...
      <footer className="landing-footer">
        ...
        <p>AI-Powered Attendance Management Platform</p>

        <span>Built with React • Node.js • Supabase • Python • Gemini AI</span>
      </footer>

      {/* Modal Placeholder */}
      {authMode && (
        <div className="auth-modal-backdrop" onClick={() => setAuthMode(null)}>
          <div
            ...
            <div className="auth-side">
              <div className="auth-side-content">
                <div className="auth-brand">
                  ...
                  <h2 className="auth-brand-title">ATTENDIFY</h2>
