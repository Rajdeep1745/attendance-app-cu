    ...
    <Router>
      <Routes>
        ...
        >
          <Route
            index
            element={<div>{user?.role === "teacher" ? "Select a batch" : "Choose a joined batch"}</div>}
          />
          ...
          <Route
            ...
            element={
              user?.role === "teacher" ? <TeacherStudents /> : <StudentStudents />
            }
          />
          <Route
            path=":batchId/reports"
            element={user?.role === "teacher" ? <TeacherReports /> : <StudentReports />}
          />
          <Route
            path=":batchId/lectures"
            element={
              user?.role === "teacher" ? <TeacherLectures /> : <StudentLectures />
            }
          />
        </Route>
